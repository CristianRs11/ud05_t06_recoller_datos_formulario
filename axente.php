<?php
    ...
    echo "<br/>O valor recibido do campo descripción dos hobbies é: ".$_REQUEST["hobbies"];
    ...
    echo "</pre>";
    echo "<br/>O nome e to tamaño do arquivo recibido no campo currículo son: ".$_FILES["curriculo"]["name"]." e "
